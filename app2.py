...
with gr.Blocks() as demo:
    ...
    def regenerate_last_response(chat_history, model, temperature, max_tokens):
        if len(chat_history) > 0:
            ...
            new_bot_message = chat(last_user_message, chat_history[:-1], model, temperature, max_tokens)
    ...
    def load_settings_fields():
        ...
        return settings["temperature"], settings["max_tokens"], generate_system_message()
